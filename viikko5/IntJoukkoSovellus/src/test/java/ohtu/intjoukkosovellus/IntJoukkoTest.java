...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.alkioKuuluu(10));
        assertFalse(joukko.alkioKuuluu(5));
        assertTrue(joukko.alkioKuuluu(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.alkioKuuluu(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.alkioKuuluu(11));
        joukko.poista(11);
        assertFalse(joukko.alkioKuuluu(11));
